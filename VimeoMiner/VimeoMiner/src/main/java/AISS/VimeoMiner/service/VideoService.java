...
public class VideoService {
    ...
    public List<Video> getVideos(String channelId, Integer maxVideos) throws MaxVideosException {
        if(maxVideos==null || maxVideos<0){
            throw new MaxVideosException();
        }else if(maxVideos>0){
            String uri="https://api.vimeo.com/channels/"+channelId+"/videos"+"?per_page="+maxVideos+
